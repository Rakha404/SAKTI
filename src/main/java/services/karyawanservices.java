...
public class karyawanservices {
    ...
    public void tambahKaryawan(String uidRfid, String idKaryawan, String namaLengkap, String divisi, String jabatan) {
        Karyawan karyawanBaru = new Karyawan(uidRfid, idKaryawan, namaLengkap, divisi, jabatan);
        DAO.save(karyawanBaru); // Memanggil insertOne melalui GenericDAO [3]
    }
    ...
    public void tampilKaryawan(JPanel panelTarget, String key) {
        ...
        try {
            for (Karyawan k : daftarKaryawan) {
                ...
                JLabel lblDiv = new JLabel("Divisi: " + k.getDivisi());
                lblDiv.setForeground(Color.WHITE);
                
                JLabel lblJbt = new JLabel("Jabatan: " + k.getJabatan());
                lblJbt.setForeground(Color.WHITE);
                ...
                cardPanel.add(lblDiv);
                cardPanel.add(lblJbt);
